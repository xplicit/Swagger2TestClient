...
namespace TestClient
{
    ...
    /// </summary>
    public partial class ReturnStreamOperations : IServiceOperations<Test>, IReturnStreamOperations
    {
        /// <summary>
        /// Initializes a new instance of the ReturnStreamOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        public ReturnStreamOperations(Test client)
        {
            if (client == null)
            {
        ...
        public async Task<HttpOperationResponse<object>> GetWithHttpMessagesAsync(IList<byte[]> data = default(IList<byte[]>), string format = "json", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "return/stream").ToString();
        ...
        public async Task<HttpOperationResponse<object>> CreateWithHttpMessagesAsync(IList<byte[]> data = default(IList<byte[]>), string format = "json", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (data != null)
            {
                StringContent _data = new StringContent(Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(data, Client.SerializationSettings).Trim('"'), System.Text.Encoding.UTF8);

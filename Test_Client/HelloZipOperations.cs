...
namespace TestClient
{
    ...
    /// </summary>
    public partial class HelloZipOperations : IServiceOperations<Test>, IHelloZipOperations
    {
        /// <summary>
        ...
        /// </exception>
        public HelloZipOperations(Test client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<HelloZipResponse>> GetWithHttpMessagesAsync(string name = default(string), IList<string> test = default(IList<string>), string format = "json", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<HelloZipResponse>> CreateWithHttpMessagesAsync(string name = default(string), IList<string> test = default(IList<string>), string format = "json", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
            ...
            if (test != null)
            {
                StringContent _test = new StringContent(Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(test, Client.SerializationSettings).Trim('"'), System.Text.Encoding.UTF8);
                _multiPartContent.Add(_test, "Test");
            }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<HelloZipResponse>> PostWithHttpMessagesAsync(string name = default(string), IList<string> test = default(IList<string>), string format = "json", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<HelloZipResponse>> DeleteWithHttpMessagesAsync(string name = default(string), IList<string> test = default(IList<string>), string format = "json", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;

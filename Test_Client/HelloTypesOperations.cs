...
namespace TestClient
{
    ...
    /// </summary>
    public partial class HelloTypesOperations : IServiceOperations<Test>, IHelloTypesOperations
    {
        /// <summary>
        ...
        /// </exception>
        public HelloTypesOperations(Test client)
        {
            if (client == null)
            {
        ...
        public async Task<HttpOperationResponse<HelloTypes>> CreateWithHttpMessagesAsync(string stringParameter = default(string), bool? boolParameter = default(bool?), int? intParameter = default(int?), string format = "json", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (boolParameter != null)
            {
                StringContent _boolParameter = new StringContent(Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(boolParameter, Client.SerializationSettings).Trim('"'), System.Text.Encoding.UTF8);
                _multiPartContent.Add(_boolParameter, "Bool");
            }
            if (intParameter != null)
            {

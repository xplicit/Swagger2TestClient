...
namespace TestClient
{
    ...
    /// </summary>
    public partial class EchoCollectionsOperations : IServiceOperations<Test>, IEchoCollectionsOperations
    {
        /// <summary>
        /// Initializes a new instance of the EchoCollectionsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        public EchoCollectionsOperations(Test client)
        {
            if (client == null)
            {
        ...
        public async Task<HttpOperationResponse<EchoCollections>> CreateWithHttpMessagesAsync(IList<string> stringList = default(IList<string>), IList<string> stringArray = default(IList<string>), object stringMap = default(object), object intStringMap = default(object), string format = "json", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (stringList != null)
            {
                StringContent _stringList = new StringContent(Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(stringList, Client.SerializationSettings).Trim('"'), System.Text.Encoding.UTF8);
                _multiPartContent.Add(_stringList, "StringList");
            }
            if (stringArray != null)
            {
                StringContent _stringArray = new StringContent(Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(stringArray, Client.SerializationSettings).Trim('"'), System.Text.Encoding.UTF8);
                _multiPartContent.Add(_stringArray, "StringArray");
            }
            if (stringMap != null)
            {
                StringContent _stringMap = new StringContent(Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(stringMap, Client.SerializationSettings).Trim('"'), System.Text.Encoding.UTF8);
                _multiPartContent.Add(_stringMap, "StringMap");
            }
            if (intStringMap != null)
            {
                StringContent _intStringMap = new StringContent(Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(intStringMap, Client.SerializationSettings).Trim('"'), System.Text.Encoding.UTF8);
                _multiPartContent.Add(_intStringMap, "IntStringMap");
            }

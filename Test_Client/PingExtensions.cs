...
namespace TestClient
{
    ...
    public static partial class PingExtensions
    {
            ...
            /// </param>
            public static object Get(this IPing operations, string format = "json")
            {
            ...
            /// </param>
            public static async Task<object> GetAsync(this IPing operations, string format = "json", CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Specifies response output format
            /// </param>
            public static object Create(this IPing operations, string format = "json")
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> CreateAsync(this IPing operations, string format = "json", CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Specifies response output format
            /// </param>
            public static object Post(this IPing operations, string format = "json")
            {
            ...
            /// Specifies response output format
            /// </param>
            public static object Delete(this IPing operations, string format = "json")
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> DeleteAsync(this IPing operations, string format = "json", CancellationToken cancellationToken = default(CancellationToken))
            {

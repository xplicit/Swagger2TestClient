...
namespace TestClient
{
    ...
    /// </summary>
    public partial class ReturnBytesOperations : IServiceOperations<Test>, IReturnBytesOperations
    {
        /// <summary>
        /// Initializes a new instance of the ReturnBytesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        public ReturnBytesOperations(Test client)
        {
            if (client == null)
            {
        ...
        public async Task<HttpOperationResponse<IList<byte[]>>> GetWithHttpMessagesAsync(IList<byte[]> data = default(IList<byte[]>), string format = "json", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "return/bytes").ToString();
